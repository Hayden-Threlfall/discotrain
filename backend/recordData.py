...
if "__main__":
    ...
    cv2.createTrackbar("L-H", "Trackbars", 0, 45, nothing)
    cv2.createTrackbar("L-S", "Trackbars", 0, 40, nothing)
    cv2.createTrackbar("L-V", "Trackbars", 0, 50, nothing)
    cv2.createTrackbar("U-H", "Trackbars", 100, 150, nothing)
    cv2.createTrackbar("U-S", "Trackbars", 155, 200, nothing)
    cv2.createTrackbar("U-V", "Trackbars", 150, 255, nothing)
    cv2.createTrackbar("e", "Trackbars", 300, 1000, nothing) #divide by one thousands
    
    font = cv2.FONT_HERSHEY_COMPLEX
    
    
    output_file = 'output3.mp4'  # Output video file name with mp4 extension
    output_file2 = 'output4.mp4'
   ...
   # cX = 0
    ...
    while True:
        ...
        #Convert this to RGB
            ...
            upper_red = np.array([110, 165, 240]) #150 190 229
